...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*brainstorm-game" workflow="/home/titux/webdev/labo/sample-project/bmad/bmm/workflows/1-analysis/brainstorm-game/workflow.yaml">Guide me through Game Brainstorming</item>
    <item cmd="*game-brief" workflow="/home/titux/webdev/labo/sample-project/bmad/bmm/workflows/1-analysis/game-brief/workflow.yaml">Create Game Brief</item>
    <item cmd="*plan-game" workflow="/home/titux/webdev/labo/sample-project/bmad/bmm/workflows/2-plan/workflow.yaml">Create Game Design Document (GDD)</item>
    <item cmd="*research" workflow="/home/titux/webdev/labo/sample-project/bmad/bmm/workflows/1-analysis/research/workflow.yaml">Conduct Game Market Research</item>
